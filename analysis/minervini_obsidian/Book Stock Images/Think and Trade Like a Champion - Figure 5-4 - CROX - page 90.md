...
# Figure 5-4 - CROX - Page 90

## Source Image

Book: [[Think and Trade Like a Champion]]

Caption: Crocs (CROX) 2008. On November 1, 2007, Crocs reported earnings up 144 percent. The stock, however, closed down 36 percent that day on the heaviest volume since its IPO. It also ended the week with the largest weekly decline on the largest volume. With stock trading, the fundamentals and the story are not as important as how institutional investors (the ones that move stock prices significantly) perceive the numbers

![](../assets/book_pages_private/think-and-trade-like-a-champion/page_090.png)

## Yahoo OHLCV Rebuild

Download status: `OK`

![](../assets/book_stock_charts/think-and-trade-like-a-champion/think-and-trade-like-a-champion-figure-5-4-crox-page-90_yahoo_rebuild.png)

CSV: `data/book_stock_images/think-and-trade-like-a-champion-figure-5-4-crox-page-90_ohlcv.csv`

## Pattern Read

Tags: ipo-base, failed-breakout-or-stage-4

Concepts: [[IPO Base New Issue Setup|IPO Base / New Issue Setup]], [[Risk First]], [[Sell Rules and Failure Signals]], [[Trend Template]]

Treat the IPO/new-issue label as a demand test: do not buy the story until price creates a controlled structure. The sell lesson dominates: when price breaks character, the chart can warn before fundamentals are obvious.
