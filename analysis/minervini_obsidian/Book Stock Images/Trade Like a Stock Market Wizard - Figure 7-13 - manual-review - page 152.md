...
# Figure 7.13 - Manual Review - Page 152

## Source Image

Book: [[Trade Like a Stock Market Wizard]]

Caption: Example of earnings acceleration versus the three- and ﬁve-year growth rate Q2 and Q3 show signiﬁcant acceleration compared with the three- and ﬁve-year growth rates with a triple-digit gain in Q3

![](../assets/book_pages_private/trade-like-a-stock-market-wizard/page_152.png)
...
> C H A P T E R 7 F U N D A M E N T A L S T O F O C U S O N 137 quarter, results are up 150 percent. Amplifying this performance are the easy comparisons from the prior year when the company was struggling. Now, as things start to turn around, not only is the company able to post higher earnings, the ...
