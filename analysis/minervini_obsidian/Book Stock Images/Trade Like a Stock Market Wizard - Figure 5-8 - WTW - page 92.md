...
# Figure 5.8 - WTW - Page 92

## Source Image

Book: [[Trade Like a Stock Market Wizard]]

Caption: Weight Watchers (WTW) 2009-2012 Weight Watchers topped in May 2011 but took a year to build a stage 3 top before transitioning to stage 4

![](../assets/book_pages_private/trade-like-a-stock-market-wizard/page_092.png)

## Yahoo OHLCV Rebuild

Download status: `OK`

![](../assets/book_stock_charts/trade-like-a-stock-market-wizard/trade-like-a-stock-market-wizard-figure-5-8-wtw-page-92_yahoo_rebuild.png)

CSV: `data/book_stock_images/trade-like-a-stock-market-wizard-figure-5-8-wtw-page-92_ohlcv.csv`
...
| last_close | 120.0 |
| max_gain_pct | 30.84 |
| max_drawdown_from_period_high_pct | -51.22 |
| first_half_depth_pct | 129.05 |
| second_half_depth_pct | 47.65 |
| tightening | True |
| volume_dryup | True |
...
| Stage 4 — Decline | ✅ | `2011-09-02` | — | 456 days | Below 200 DMA: False |
...
- Status: `ok`
- Entry date: `2010-04-14`
- Pre-entry history available: `474 sessions`
...
- 50/150/200 DMA first aligned (50>150>200): `2009-07-23`
