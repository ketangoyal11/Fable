...
ticker: "AAPL"
yahoo_symbol: "AAPL"
date_range: "1985-2010"
extraction_confidence: "caption-with-ticker"
generated: "2026-05-17"
private_source_image: true
---

# Figure 6.2 - AAPL - Page 121

## Source Image

Book: [[Trade Like a Stock Market Wizard]]

Caption: Apple Computer (AAPL) 1985-2010 Apple Computer experiences a phenomenal turnaround on the heels of newly released products including the iPod, iTunes, and the iPhone. Created by Max Olson/Max Capital Corporation

![](../assets/book_pages_private/trade-like-a-stock-market-wizard/page_121.png)

## Yahoo OHLCV Rebuild

Download status: `OK`

![](../assets/book_stock_charts/trade-like-a-stock-market-wizard/trade-like-a-stock-market-wizard-figure-6-2-aapl-page-121_yahoo_rebuild.png)

CSV: `data/book_stock_images/trade-like-a-stock-market-wizard-figure-6-2-aapl-page-121_ohlcv.csv`
...
| first_close | 0.1144 |
| last_close | 18.1996 |
| max_gain_pct | 21912.0 |
| max_drawdown_from_period_high_pct | -83.08 |
| first_half_depth_pct | 910.35 |
| second_half_depth_pct | 10986.0 |
| tightening | False |
| volume_dryup | False |
...
| Stage 4 — Decline | ✅ | `2008-07-22` | — | 741 days | Below 200 DMA: False |
...
- Status: `ok`
- Entry date: `2004-11-19`
- Pre-entry history available: `5169 sessions`
...
- First sustained Stage 2 date: `1999-04-23`
- Days in Stage 2 before entry: `1403`
...
- 50/150/200 DMA first aligned (50>150>200): `1986-02-06`
...
- Lesson: Stage 2 was established 1403 days before entry, confirming leadership context. Total pre-entry range was 120.1% — wide range indicating significant prior movement. Volume did not show clear dry-up — supply may still be present.
...
- Setup type: `stage-2-leadership-study`
- Confidence: `high`
- Timing source: `1985-2010` from the figure caption and rebuilt OHLCV where available.
