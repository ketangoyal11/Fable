...
# Figure 10.4 - Manual Review - Page 215

## Source Image

Book: [[Trade Like a Stock Market Wizard]]

Caption: Example of volatility contraction “Ts” 1T 2T 3T 4T 5T

![](../assets/book_pages_private/trade-like-a-stock-market-wizard/page_215.png)
...
Concepts: [[Mental Discipline]], [[Volatility Contraction Pattern]], [[VCP Footprint]]
...
- Drawing count (annotations): `24`
- Chapter context: `picture-study`

### Annotation Reading Guide

Heavily annotated page (24 drawing elements). Look for: pivot markers, stop levels, trend lines, volume annotations, stage labels, and base boundaries. These annotations are the author's own teaching marks.
...
> 200 T R A D E L I K E A S T O C K M A R K E T W I Z A R D that is four to seven weeks in duration. With this type of base, there is no real volatility contraction as it remains a tight and narrow pattern or box, mov- ing in a sideways range with about a 10 to 15 percent correction from high point to...
