...
# Figure 8.4 - LULU - Page 163

## Source Image

Book: [[Trade Like a Stock Market Wizard]]

Caption: Lululemon Athetica Inc. (LULU) 2011-2011 Lululemon experienced post earnings drift (PED) after reporting earnings in September and December 2010

![](../assets/book_pages_private/trade-like-a-stock-market-wizard/page_163.png)

## Yahoo OHLCV Rebuild

Download status: `OK`

![](../assets/book_stock_charts/trade-like-a-stock-market-wizard/trade-like-a-stock-market-wizard-figure-8-4-lulu-page-163_yahoo_rebuild.png)

CSV: `data/book_stock_images/trade-like-a-stock-market-wizard-figure-8-4-lulu-page-163_ohlcv.csv`
...
| first_half_depth_pct | 2537.41 |
| second_half_depth_pct | 97.84 |
| tightening | True |
| volume_dryup | False |
...
| Stage 2 — Advance | ✅ | `2010-09-10` | `2011-08-17` | 236 days | Max gain: 218.2% |
| Stage 3 — Distribution | ✅ | `2011-09-09` | `2011-09-30` | 15 days | no climax |
| Stage 4 — Decline | ✅ | `2011-10-03` | — | 186 days | Below 200 DMA: False |
...
- Lesson: Stage 1 base was deep-chaotic with 121.4% depth. Stage 2 advance lasted 237 sessions with 5 significant pivots. VCP footprint shows 4 contractions with mixed quality.
...
- Confidence: `high`
- Timing source: `2010-2011` from the figure caption and rebuilt OHLCV where available.
