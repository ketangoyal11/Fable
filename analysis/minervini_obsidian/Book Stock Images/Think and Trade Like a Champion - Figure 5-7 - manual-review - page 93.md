...
yahoo_symbol: ""
date_range: "-"
extraction_confidence: "caption-no-ticker"
generated: "2026-05-17"
private_source_image: true
---

# Figure 5-7 - Manual Review - Page 93

## Source Image

Book: [[Think and Trade Like a Champion]]

Caption: Trader A allows the stock to drop 20 percent and then nails down a 20 percent profit, a 1:1 reward/risk ratio. Trader B, in contrast, makes 4:1 on his money, risking 5 percent for a 20 percent return. Which trader do you think will be the bigger winner over many trades? LONGEVITY IS THE KEY In my first book, I told the story of achieving a 259 score during my very first year playing in a Wednesday night bowling leagu

![](../assets/book_pages_private/think-and-trade-like-a-champion/page_093.png)
...
Concepts: [[Mental Discipline]], [[Reward Risk Ratio]]
...
- Confidence: `low`
- Timing source: `-` from the figure caption and rebuilt OHLCV where available.
...
- Drawing count (annotations): `0`
- Chapter context: `compounding`

### Annotation Reading Guide

No annotations detected. The chart may be shown as-is without author markings. Focus on price/volume structure.
...
> smart. You would much rather risk $150 to win $550. If your hand has a 50/50 chance of winning, then you need to get better than 2:1 odds on your wager to justify making the bet. Stock trading is no different. Assuming your trade has a 50/50 chance of success, taking a 20 percent risk to make 20 per...
...
- Lesson: This case lacks OHLCV reconstruction. Use the source image and chapter context (compounding) for manual analysis. Inferred stage from tags: uncertain-manual-review. Likely base type: unknown-manual-review.
